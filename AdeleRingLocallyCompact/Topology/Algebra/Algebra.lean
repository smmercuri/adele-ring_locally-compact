...
theorem ContinuousAlgHom.ext_iff {R A B : Type*}[CommSemiring R]
...
theorem uniformEmbedding {E₁ E₂ : Type*} [UniformSpace E₁] [UniformSpace E₂] [Ring E₁]
    ...
    (e : E₁ ≃A[R] E₂) : UniformEmbedding e :=
  e.toAlgEquiv.uniformEmbedding e.toContinuousAlgHom.uniformContinuous
